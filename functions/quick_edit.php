...
function custom_quick_edit( $column_name, $post_type ) {
  ...
  if ( $print_nonce ) {
    ...
    // seo
    if ( in_array( $post_type, array( 'post', 'page', 'news', 'product' ) ) ) {
  ...
  <div class="inline-edit-col column-meta-seo">
    <div class="inline-edit-group">
      <label class="inline-edit-tcd-w_meta_title">
        <span class="title"><?php _e('Title tag', 'tcd-ankle'); ?></span>
      ...
      <label class="inline-edit-tcd-w_meta_description">
        <span class="title" style="line-height:1.5;"><?php _e('Meta description tag', 'tcd-ankle');  ?></span>
...
<fieldset class="inline-edit-col-right">
  <div class="inline-edit-col column-recommend">
    <div class="inline-edit-group">
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post1" value="on" /> <?php _e( 'Show this post for recommend post1', 'tcd-ankle' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post2" value="on" /> <?php _e( 'Show this post for recommend post2', 'tcd-ankle' );  ?></label>
      <label style="line-height:1.5;"><input type="checkbox" name="recommend_post3" value="on" /> <?php _e( 'Show this post for recommend post3', 'tcd-ankle' );  ?></label>
    </div>
  </div>
</fieldset>
<?php
