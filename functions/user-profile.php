...
<div class="custom_category_meta" style="margin:20px 0;">
 <h3 class="ccm_headline"><?php _e( 'Additional user data', 'tcd-ankle' ); ?></h3>
...
<?php
	...
	// 以下全ユーザー
?>
  <h4 class="headline"><?php _e( 'Profile image', 'tcd-ankle' ); ?></h4>
  <div class="input_field">
   <p><?php printf(__('Recommend image size. Width:%1$spx, Height:%2$spx.', 'tcd-ankle'), '360', '360'); ?></p>
...
?>
	...
	<div class="button_area">
		<input type="button" class="cfmf-select-img button" value="<?php _e( 'Select Image', 'tcd-ankle' ); ?>">
		<input type="button" class="cfmf-delete-img button<?php if ( ! $media_id ) echo ' hidden'; ?>" value="<?php _e( 'Remove Image', 'tcd-ankle' ); ?>">
	</div>
</div>
<style>
