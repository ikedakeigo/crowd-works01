...
if($thumnail_image){
	...
	$noimage = array();
	$noimage[0] = esc_url(get_bloginfo('template_url')) . "/img/common/no_image1.gif";
	$pinterestimage = $options['no_image1']? wp_get_attachment_image_src( $options['no_image1'], 'full' ) : $noimage;
}
?>
<div class="share-<?php echo esc_attr( $options['sns_share_design_type'] ); ?> single_share_button">
<?php
// Type5
